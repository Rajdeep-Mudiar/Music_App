...
class MusicService {
  ...
  Future<List<Track>> searchTracks(String query, {int limit = 20}) async {
    ...
    return _getFallbackTracks().where((t) => t.title.toLowerCase().contains(query.toLowerCase()) || t.artist.toLowerCase().contains(query.toLowerCase())).toList();
  }

  Future<List<Track>> getStudyTracks({String vibe = 'lofi', int limit = 20}) async {
    try {
      final res = await apiClient.dio.get(
  ...
  List<Track> _getFallbackTracks() {
    return [
      ...
      Track(
        ...
        duration: 210,
        artworkUrl: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=500',
      ...
      Track(
        ...
        duration: 240,
        artworkUrl: 'https://images.unsplash.com/photo-1519791883288-dc8bd696e667?w=500',
        streamUrl: 'https://cdn.pixabay.com/download/audio/2021/09/06/audio_73138bcf53.mp3?filename=rain-and-thunder-nature-sounds-7803.mp3',
        genre: 'Ambient',
      ),
      Track(
        id: 'study_synth_6',
