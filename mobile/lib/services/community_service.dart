...
class CommunityService {
  ...
  Future<PostModel?> createPost(
      {required String content, Track? songAttachment}) async {
    try {
  ...
  Future<List<EventModel>> getEvents({String? university}) async {
    ...
    return [
      EventModel(
        ...
        description:
            'Student singer-songwriters showcase their original indie and acoustic music.',
      ...
      EventModel(
        ...
        description:
            'Live continuous DJ set paired with 24-hour campus hackathon sprint.',
  ...
  List<PostModel> _getFallbackPosts() {
    return [
      PostModel(
        ...
        content:
            'Late night OS lab assignment deadline! This synth track is keeping the brain cells alive ⚡',
      ...
      PostModel(
        ...
        content:
            'Anyone studying in Central Library 2nd floor? Rain sounds outside + Lo-Fi in headphones = 100% focus ✨',
        songAttachment: Track(
          id: 'study_lofi_1',
